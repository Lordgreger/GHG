...
namespace BeardedManStudios.Forge.Networking.Generated
{
	...
	public partial class PlayerNetworkObject : NetworkObject
	{
		...
		public event FieldEvent<Vector2> rotationChanged;
		public InterpolateVector2 rotationInterpolation = new InterpolateVector2() { LerpT = 0.15f, Enabled = true };
		...
		protected override void ReadPayload(BMSByte payload, ulong timestep)
		{
			...
			_rotation = UnityObjectMapper.Instance.Map<Vector2>(payload);
		...
		protected override void ReadDirtyFields(BMSByte data, ulong timestep)
		{
			...
			if ((0x2 & readDirtyFlags[0]) != 0)
			{
				...
				{
					rotationInterpolation.target = UnityObjectMapper.Instance.Map<Vector2>(data);
					rotationInterpolation.Timestep = timestep;
				}
				else
				{
					_rotation = UnityObjectMapper.Instance.Map<Vector2>(data);
					RunChange_rotation(timestep);
				}
			}
		...
		public override void InterpolateUpdate()
		{
			...
			{
				_rotation = (Vector2)rotationInterpolation.Interpolate();
